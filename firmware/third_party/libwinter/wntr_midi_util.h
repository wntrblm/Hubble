...
inline static uint8_t wntr_midi_get_type(const struct WntrMIDIMessage* msg) { return msg->status & 0xF0; }
inline static uint8_t wntr_midi_get_channel(const struct WntrMIDIMessage* msg) { return msg->status & 0xF; }

inline static uint16_t wntr_midi_get_pitch_bend(const struct WntrMIDIMessage* msg) {
    return (msg->data_1 << 7 | msg->data_0);
}

inline static uint16_t wntr_midi_get_pitch_bend_u16(const struct WntrMIDIMessage* msg) {
